...
class SubusersViewUsers extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->orgsearch = $app->getUserStateFromRequest('.filter.search', 'filter_org_search', '', 'string');

		$this->orgListArray = SubusersAclHelper::getAllOrganizations();
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_SUBUSERS_DEFAULT_USERS_TITLE'));
		}

		if (empty($title))
		{
			$title = JText::_('COM_SUBUSERS_USERS_LIST_PAGE_TITLE');
		}

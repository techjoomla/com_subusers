 ...
 * @since  1.6
 */
class SubusersModelRoleForm extends JModelForm
{
	private $item = null;
	...
	protected function populateState()
	{
		...
		{
			$id = JFactory::getApplication()->getUserState('com_subusers.edit.role.id');
		}
		else
		{
			$id = JFactory::getApplication()->input->get('id');
			JFactory::getApplication()->setUserState('com_subusers.edit.role.id', $id);
		}
	...
	{
		// Get the form.
		$form = $this->loadForm('com_subusers.role', 'roleform', array(
			'control'   => 'jform',
			'load_data' => $loadData
			)
		);

...
if ($saveOrder)
{
	...
	JHtml::_('sortablelist.sortable', 'mappingList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_subusers&view=mappings'); ?>" method="post"
	...
	<?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.`state`', $listDirn, $listOrder); ?>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_SUBUSERS_MAPPINGS_ROLE_ID', 'a.`role_id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_SUBUSERS_MAPPINGS_ACTION_ID', 'a.`action_id`', $listDirn, $listOrder); ?>
				</th>

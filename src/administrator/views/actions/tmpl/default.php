...
<form action="<?php echo JRoute::_('index.php?option=com_subusers&view=actions'); ?>" method="post"
	...
	<?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.`state`', $listDirn, $listOrder); ?>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_SUBUSERS_ACTIONS_NAME', 'a.`name`', $listDirn, $listOrder); ?>
				</th>
	...
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'actions.', $canChange, 'cb'); ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_subusers&task=action.edit&id='.(int) $item->id); ?>">

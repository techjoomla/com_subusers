 ...
 * @since  1.6
 */
class SubusersViewActions extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SUBUSERS_TITLE_ACTIONS'), 'actions.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				JToolbarHelper::custom('actions.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
			}
		...
		JHtmlSidebar::setAction('index.php?option=com_subusers&view=actions');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_SUBUSERS_ACTIONS_NAME'),

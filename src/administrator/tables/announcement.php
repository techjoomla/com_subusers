 ...
 * @since  1.6
 */
class SubusersTableannouncement extends JTable
{
	/**
	 * Constructor
	 *
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_subusers.announcement.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_subusers/access.xml',
				"/access/section[@name='announcement']/"
			);
			$default_actions = JAccess::getAssetRules('com_subusers.announcement.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	public function delete($pk = null)
	{
		...
		if ($result)
		{
			...
			{
				JFile::delete(JPATH_ROOT . '/images/partners/' . $logoFile);
			}
		}
